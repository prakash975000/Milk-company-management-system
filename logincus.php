...
<html>
<head>
  <title>Customer login and registration form</title>
  ...
  <div class="hero">
    <div style="border-radius: 70px" class="form-box">
      <div>
          ...
          <p style="text-align: center;font-weight: 20px;font-size: 30px;">Customer</p>
        </div>
      ...
      <form id="login" class="input-group" action="logincusconn.php" method="post" >
      ...
      <form id="register" class="input-group1" action="cusconn.php" method="POST">

      <input type="text" name="username" class="input-field"  required="" placeholder="User Id (ex:cus1,cus2..,etc.)">
