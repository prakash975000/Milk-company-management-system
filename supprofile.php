...
$query="select * from supplier where username='$p'";
...
if($total!=0)
{
	...
	<div class="lable">
			...
			<label>Email id &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp </label>
			...
			<button  id="submit" type="submit" name="update" value="update" class="su"/>submit</button>
	</div> 
</div>
		</form>
	...
	if (mysqli_connect_error())
		...
		else
		{
			if(isset($_POST['update']))
			{
			    ...
			    if($count>0)
			    {
					$UPDATE = "UPDATE `supplier` SET `name`='$name',`address`='$address',`phno`='$phno',`email`='$email',`passwd`='$passwd' WHERE `username`='$username'";
