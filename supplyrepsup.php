...
?>
<p style="text-align: center;font-size: 30px;margin-top: 4%;margin-left: 15%;"><b><u>Supply Report</u></b></p>
...
if(isset($_POST['search']))
{
	$f=$_POST['payf'];
	$t=$_POST['payt'];
	$query="select sum(litre) as lit,sum(advance) as adv,date from purchase where username='$p' && date between '$f' and '$t'";
