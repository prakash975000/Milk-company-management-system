  ...
  <div class="hero">
    <div style="border-radius: 70px" class="form-box">
    	<div>
    			...
    			<p style="text-align: center;font-weight: 20px;font-size: 30px;">Employee</p>
    		</div>
    	...
    	<form id="login" class="input-group" action="loginempconn.php" method="post" >
    	...
    	<form onchange="check_pass()" id="register" class="input-group1" action="empconn.php" method="POST" >

			<input type="text"  name="username" class="input-field"  required="" placeholder="User Id (ex:emp1,emp2..,etc.)">
